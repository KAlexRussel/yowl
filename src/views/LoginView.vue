...
import { login } from '@/api/AuthentificateApi';
...
<template>
  ...
  <div class="min-w-screen min-h-screen flex items-center justify-center px-5 py-5">
    <div class=" text-gray-500 w-full overflow-hidden" style="max-width:1000px">
      <div class="justify-center flex  before:flex-1 after:mt-0.5 after:flex-1 ">
        <img src='@/assets/gunBleu.png' alt="agun logo" class=" ">
      </div>
      <div class="md:flex w-full">
        <div class="hidden rounded-xl md:block w-1/2 py-10 px-10">
          <svg id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
            ...
            <path id="e73810fe-4cf4-40cc-8c7c-ca544ce30bd4" data-name="Path 7"
              ...
              transform="translate(-227.576 -76.46149)" fill="#ccc" />
            <circle id="a4813fcf-056e-4514-bb8b-e6506f49341f" data-name="Ellipse 1" cx="364.43401" cy="261.50202"
              r="24.45" fill="#6c63ff" />
            ...
            <circle id="fcef55fc-4968-45b2-93bb-1a1080c85fc7" data-name="Ellipse 2" cx="225.46401" cy="427.41999"
              r="6.902" fill="#6c63ff" />
            <rect id="ff33d889-4c74-4b91-85ef-b4882cc8fe76" data-name="Rectangle 2" x="218.56201" y="516.11803"
              width="218.552" height="2.047" fill="#ccc" />
            <circle id="e8fa0310-b872-4adf-aedd-0c6eda09f3b8" data-name="Ellipse 3" cx="225.46401" cy="496.43702"
              r="6.902" fill="#6c63ff" />
            <path
            ...
            <circle id="e12ee00d-aa4a-4413-a013-11d20b7f97f7" data-name="Ellipse 7" cx="247.97799" cy="427.41999"
              r="6.902" fill="#6c63ff" />
            <circle id="f58f497e-6949-45c8-be5f-eee2aa0f6586" data-name="Ellipse 8" cx="270.492" cy="427.41999"
              r="6.902" fill="#6c63ff" />
            <circle id="b4d4939a-c6e6-4f4d-ba6c-e8b05485017d" data-name="Ellipse 9" cx="247.97799" cy="496.43702"
              r="6.902" fill="#6c63ff" />
        ...
        <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
          <form @submit.stop.prevent class="flex flex-col w-full gap-y-5 max-w-md ">
            ...
            <div class="flex flex-row items-center justify-center lg:justify-start">
              ...
              <div class=" items-center justify-between">
                ...
                <p class="text-4xl font-bold text-center my-5 text-black">
                  LOG IN
                </p>
              </div>
            </div>

            <p class="text-red-500 text-sm italic" v-show="errors !== null"> {{ errors }} </p>
            ...
            <div class="flex justify-between">
              ...
              <div class="mb-6 flex text-sm items-center justify-between">
            ...
            <div class="flex justify-center">
              ...
              <ButtonComponent @click="handleLog()" css="bg-[#2C53C6] text-white text-xl w-2/3 py-3" type="submit">
                Log In
              </ButtonComponent>
