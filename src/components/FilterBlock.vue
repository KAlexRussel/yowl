...
<template>
    <div class="flex flex-col gap-y-5 rounded-lg p-8 justify-center bg-white">
        <div class="flex gap-x-7 items-center">
            <p><svg width="30px" height="30px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex flex-col gap-y-4">
            <select name=""
                class="flex justify-between text-black bg-[#f5f5f5] text-black items-center rounded-3xl px-5 py-4 outline-0 focus:outline-0"
                v-model="category">
                <option value="">
                    Category
                </option>
            ...
            <select name=""
                class="flex justify-between bg-[#f5f5f5] text-black items-center rounded-3xl px-5 py-4 outline-0 focus:outline-0">
                <option value="">Publish Date</option>
            </select>
            <ButtonComponent css="flex gap-12 bg-[#f5f5f5] text-black items-center  py-4" v-if="!props.condition">
                <p>
